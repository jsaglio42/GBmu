...
class RomHeaderData {
  ...
  RomHeaderData(Uint8List l)
  : data = new Map<String, dynamic>()
  {
    if (l.length < 0x150)
      throw new FormatException('ROM Header: ROM Size is below 0x150 bytes');
    try {
      headerFieldInfos.forEach(
        (headerInfo) {
      ...
      print (e);
      throw new FormatException('ROM Header: Header is not valid');
    }
  }
