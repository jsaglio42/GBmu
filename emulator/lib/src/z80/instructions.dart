...
final instInfos = new List<InstructionInfo>.unmodifiable([
  ...
  new InstructionInfo(0x01,   1,   2,  12,  12,   'LD BC, nn',       '- - - -'),
  ...
  new InstructionInfo(0x06,   1,   1,   8,   8,   'LD B, n',         '- - - -'),
  new InstructionInfo(0x07,   1,   0,   4,   4,   'RLCA',            '0 0 0 C'),
  new InstructionInfo(0x08,   1,   2,  20,  20,   'LD (nn), SP',     '- - - -'),
  ...
  new InstructionInfo(0x0E,   1,   1,   8,   8,   'LD C, n',         '- - - -'),
  new InstructionInfo(0x0F,   1,   0,   4,   4,   'RRCA',            '0 0 0 C'),
  new InstructionInfo(0x10,   1,   1,   4,   4,   'STOP',            '- - - -'),
  new InstructionInfo(0x11,   1,   2,  12,  12,   'LD DE, nn',       '- - - -'),
  ...
  new InstructionInfo(0x16,   1,   1,   8,   8,   'LD D, n',         '- - - -'),
  new InstructionInfo(0x17,   1,   0,   4,   4,   'RLA',             '0 0 0 C'),
  new InstructionInfo(0x18,   1,   1,  12,  12,   'JR e',            '- - - -'),
  ...
  new InstructionInfo(0x1E,   1,   1,   8,   8,   'LD E, n',         '- - - -'),
  new InstructionInfo(0x1F,   1,   0,   4,   4,   'RRA',             '0 0 0 C'),
  new InstructionInfo(0x20,   1,   1,  12,   8,   'JR NZ, e',        '- - - -'),
  new InstructionInfo(0x21,   1,   2,  12,  12,   'LD HL, nn',       '- - - -'),
  ...
  new InstructionInfo(0x26,   1,   1,   8,   8,   'LD H, n',         '- - - -'),
  new InstructionInfo(0x27,   1,   0,   4,   4,   'DAA',             'Z - 0 C'),
  new InstructionInfo(0x28,   1,   1,  12,   8,   'JR Z, e',         '- - - -'),
  ...
  new InstructionInfo(0x2E,   1,   1,   8,   8,   'LD L, n',         '- - - -'),
  new InstructionInfo(0x2F,   1,   0,   4,   4,   'CPL',             '- 1 1 -'),
  new InstructionInfo(0x30,   1,   1,  12,   8,   'JR NC, e',        '- - - -'),
  new InstructionInfo(0x31,   1,   2,  12,  12,   'LD SP, nn',       '- - - -'),
  ...
  new InstructionInfo(0x36,   1,   1,  12,  12,   'LD (HL), n',      '- - - -'),
  new InstructionInfo(0x37,   1,   0,   4,   4,   'SCF',             '- 0 0 1'),
  new InstructionInfo(0x38,   1,   1,  12,   8,   'JR C, e',         '- - - -'),
  ...
  new InstructionInfo(0x3E,   1,   1,   8,   8,   'LD A, n',         '- - - -'),
  ...
  new InstructionInfo(0xC2,   1,   2,  16,  12,   'JP NZ, nn',       '- - - -'),
  new InstructionInfo(0xC3,   1,   2,  16,  16,   'JP nn',           '- - - -'),
  new InstructionInfo(0xC4,   1,   2,  24,  12,   'CALL NZ, nn',     '- - - -'),
  ...
  new InstructionInfo(0xCA,   1,   2,  16,  12,   'JP Z, nn',        '- - - -'),
  new InstructionInfo(0xCB,   1,   0,   0,   0,   '0xCB: PREFIX',    '- - - -'),
  new InstructionInfo(0xCC,   1,   2,  24,  12,   'CALL Z, nn',      '- - - -'),
  new InstructionInfo(0xCD,   1,   2,  24,  24,   'CALL nn',         '- - - -'),
  ...
  new InstructionInfo(0xD2,   1,   2,  16,  12,   'JP NC, nn',       '- - - -'),
  new InstructionInfo(0xD3,   1,   0,   4,   4,   '0xD3: NOP',       '- - - -'),
  new InstructionInfo(0xD4,   1,   2,  24,  12,   'CALL NC, nn',     '- - - -'),
  new InstructionInfo(0xD5,   1,   0,  16,  16,   'PUSH DE',         '- - - -'),
  new InstructionInfo(0xD6,   1,   1,   8,   8,   'SUB n',           'Z 1 H C'),
  new InstructionInfo(0xD7,   1,   0,  16,  16,   'RST 10H',         '- - - -'),
  new InstructionInfo(0xD8,   1,   0,  20,   8,   'RET C',           '- - - -'),
  new InstructionInfo(0xD9,   1,   0,  16,  16,   'RETI',            '- - - -'),
  new InstructionInfo(0xDA,   1,   2,  16,  12,   'JP C, nn',        '- - - -'),
  new InstructionInfo(0xDB,   1,   0,   4,   4,   '0xDB: NOP',       '- - - -'),
  new InstructionInfo(0xDC,   1,   2,  24,  12,   'CALL C, nn',      '- - - -'),
  new InstructionInfo(0xDD,   1,   0,   4,   4,   '0xDD: NOP',       '- - - -'),
  new InstructionInfo(0xDE,   1,   1,   8,   8,   'SBC A, d8',       'Z 1 H C'),
  new InstructionInfo(0xDF,   1,   0,  16,  16,   'RST 18H',         '- - - -'),
  new InstructionInfo(0xE0,   1,   1,  12,  12,   'LD (0xFF+n), A',  '- - - -'),
  new InstructionInfo(0xE1,   1,   0,  12,  12,   'POP HL',          '- - - -'),
  new InstructionInfo(0xE2,   1,   1,   8,   8,   'LD (0xFF+C), A',  '- - - -'),
  new InstructionInfo(0xE3,   1,   0,   4,   4,   '0xE3: NOP',       '- - - -'),
  new InstructionInfo(0xE4,   1,   0,   4,   4,   '0xE4: NOP',       '- - - -'),
  new InstructionInfo(0xE5,   1,   0,  16,  16,   'PUSH HL',         '- - - -'),
  new InstructionInfo(0xE6,   1,   1,   8,   8,   'AND n',           'Z 0 1 0'),
  new InstructionInfo(0xE7,   1,   0,  16,  16,   'RST 20H',         '- - - -'),
  new InstructionInfo(0xE8,   1,   1,  16,  16,   'ADD SP, e',       '0 0 H C'),
  new InstructionInfo(0xE9,   1,   0,   4,   4,   'JP (HL)',         '- - - -'),
  new InstructionInfo(0xEA,   1,   2,  16,  16,   'LD (nn), A',      '- - - -'),
  new InstructionInfo(0xEB,   1,   0,   4,   4,   '0xEB: NOP',       '- - - -'),
  new InstructionInfo(0xEC,   1,   0,   4,   4,   '0xEC: NOP',       '- - - -'),
  new InstructionInfo(0xED,   1,   0,   4,   4,   '0xED: NOP',       '- - - -'),
  new InstructionInfo(0xEE,   1,   1,   8,   8,   'XOR n',           'Z 0 0 0'),
  new InstructionInfo(0xEF,   1,   0,  16,  16,   'RST 28H',         '- - - -'),
  new InstructionInfo(0xF0,   1,   1,  12,  12,   'LD A, (0xFF+n)',  '- - - -'),
  new InstructionInfo(0xF1,   1,   0,  12,  12,   'POP AF',          'Z N H C'),
  new InstructionInfo(0xF2,   1,   1,   8,   8,   'LD A, (0xFF+C)',  '- - - -'),
  new InstructionInfo(0xF3,   1,   0,   4,   4,   'DI',              '- - - -'),
  new InstructionInfo(0xF4,   1,   0,   4,   4,   '0xF4: NOP',       '- - - -'),
  new InstructionInfo(0xF5,   1,   0,  16,  16,   'PUSH AF',         '- - - -'),
  new InstructionInfo(0xF6,   1,   1,   8,   8,   'OR n',            'Z 0 0 0'),
  new InstructionInfo(0xF7,   1,   0,  16,  16,   'RST 30H',         '- - - -'),
  new InstructionInfo(0xF8,   1,   1,  12,  12,   'LD HL, SP+e',     '0 0 H C'),
  new InstructionInfo(0xF9,   1,   0,   8,   8,   'LD SP, HL',       '- - - -'),
  new InstructionInfo(0xFA,   1,   2,  16,  16,   'LD A, (nn)',      '- - - -'),
  new InstructionInfo(0xFB,   1,   0,   4,   4,   'EI',              '- - - -'),
  new InstructionInfo(0xFC,   1,   0,   4,   4,   '0xFC: NOP',       '- - - -'),
  new InstructionInfo(0xFD,   1,   0,   4,   4,   '0xFD: NOP',       '- - - -'),
  new InstructionInfo(0xFE,   1,   1,   8,   8,   'CP n',            'Z 1 H C'),
...
final instInfos_CB = new List<InstructionInfo>.unmodifiable([
  ...
  new InstructionInfo(0x46CB,   2,   0,  12,  12,   'BIT 0,(HL)',   'Z 0 1 -'),
  ...
  new InstructionInfo(0x4ECB,   2,   0,  12,  12,   'BIT 1,(HL)',   'Z 0 1 -'),
  ...
  new InstructionInfo(0x56CB,   2,   0,  12,  12,   'BIT 2,(HL)',   'Z 0 1 -'),
  ...
  new InstructionInfo(0x5ECB,   2,   0,  12,  12,   'BIT 3,(HL)',   'Z 0 1 -'),
  ...
  new InstructionInfo(0x66CB,   2,   0,  12,  12,   'BIT 4,(HL)',   'Z 0 1 -'),
  ...
  new InstructionInfo(0x6ECB,   2,   0,  12,  12,   'BIT 5,(HL)',   'Z 0 1 -'),
  ...
  new InstructionInfo(0x76CB,   2,   0,  12,  12,   'BIT 6,(HL)',   'Z 0 1 -'),
  ...
  new InstructionInfo(0x7ECB,   2,   0,  12,  12,   'BIT 7,(HL)',   'Z 0 1 -'),
