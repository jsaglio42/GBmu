...
const int WORKING_RAM_LAST = FORBIDDEN_MEM_FIRST - 1;
const int WORKING_RAM_FIRST = 0xC000;
const int WORKING_RAM_SIZE = WORKING_RAM_LAST - WORKING_RAM_FIRST + 1;

const int CARTRIDGE_RAM_LAST = WORKING_RAM_FIRST - 1;
const int CARTRIDGE_RAM_FIRST = 0xA000;
const int CARTRIDGE_RAM_SIZE = CARTRIDGE_RAM_LAST - CARTRIDGE_RAM_FIRST + 1;

const int VIDEO_RAM_LAST = WORKING_RAM_FIRST - 1;
